...
par(mfrow=c(2,2))
ggplot(data_cor, aes(x=LNNBELPOV, y=LNMEDHVAL)) + geom_point()
ggplot(data_cor, aes(x=PCTBACHMOR, y=LNMEDHVAL)) + geom_point()
ggplot(data_cor, aes(x=PCTVACANT, y=LNMEDHVAL)) + geom_point()
ggplot(data_cor, aes(x=PCTSINGLES, y=LNMEDHVAL)) + geom_point()
```
