...
From the new histograms, we can see that LNPCTBACHMOR, LNPCTVACANT, LNPCTSINGLES are all having zero inflations, which means that there are very high zero/low value bar in the histograms after log transformation. Keep that in mind, we will ony use Log Median House Value LNMEDHVAL, and Log Number of Household living in Poverty LNNBELPV100 for the following regression analysis, while keep the other three variables orginial. 
